...
public class olumsuzluk_ıksırı : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        taskImage = gorevCanvas.transform.Find("Panel/Image(2)").gameObject;
        textLegacy = gorevCanvas.transform.Find("Panel/Text (Legacy)(3)").gameObject;
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (rend != null)
        {
            ...
            if (IsColorSimilar(renk, new Color(191f / 255f, 154f / 255f, 64f / 255f)))
            {
